...
contract DemoGDA {
    ...
    function createPool(string memory _poolName, string memory _poolSymbol) external returns (ISuperfluidPool pool) {
        ...
        pool = superToken.createPoolWithCustomERC20Metadata(address(this), poolConfig, poolERC20Metadata);
